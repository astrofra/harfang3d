...
cube_node, cube_rb = CreatePhysicCubeEx(scene, cube_size, hg.TranslationMat4(hg.Vec3(1.5, 0.5, 0)), cube_ref, {mat_grey}, hg.RBT_Dynamic, 1.0)
...
while not keyboard:Down(hg.K_Escape) and hg.IsWindowOpen(win) do
    ...
    -- apply force
    physics:NodeAddForce(cube_node, hg.Vec3(-1.0,0,0))
