...
physics_cube_node,_ = CreatePhysicCubeEx(scene, cube_size, hg.TranslationMat4(hg.Vec3(0, 0, 0)), cube_ref, {mat_grey}, hg.RBT_Kinematic, 1.0)
...
print(">>> Description:\n>>> The cube, a rigid body kinematic node, is parented to a non-physics empty node.\n>>> The parent node position and rotation is updated in the rendering loop.\n>>> The cube shall move from left to right and rotate on its Y axis.")
