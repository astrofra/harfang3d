...
octogone_instance, _ = hg.CreateInstanceFromAssets(scene, hg.TranslationMat4(hg.Vec3(0, 0, 0)), "octogone/octogone.scn",
...
print(
    ">>> Description:\n>>> Create a mesh collider with octogon surface from .physics_bullet file from the plane geometry and test the collisions with raycasts.")
