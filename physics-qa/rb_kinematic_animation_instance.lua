...
cam_mat = hg.TransformationMat4(hg.Vec3(0, 4, -10), hg.Vec3(hg.Deg(20), 0, 0))
...
cube_instance, _ = hg.CreateInstanceFromAssets(scene, hg.TranslationMat4(hg.Vec3(0, 0, 0)), "cube_animated/cube.scn", res, hg.GetForwardPipelineInfo())
anim = cube_instance:GetInstanceSceneAnim("cube_move")
anim_ref = scene:PlayAnim(anim, hg.ALM_Loop)
...
print(">>> Description:\n>>> Set the position and rotation of an instantiated kinematic using its animation.")
